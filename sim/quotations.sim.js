...
(function(){
  ...
  ['qTot','openQDoc','markSent','moreQ',
   ...
   'computeTodaysActions','rDailyBrief','renderTodaysActions','rPipeline','rSchedule','rInvoices',
   'rClients','rCustomers','rAnalytics','rFinance','rSettings','rMessages','lCard','cardCTA'
