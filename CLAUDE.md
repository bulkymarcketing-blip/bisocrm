...
- **Next: Phase 6 (Data screens — Quotations / Invoices / Finance / Confirmed / Profiles / Analytics).** Reuse the Phase-4 `_brief*` vocabulary + the Phase-5 `.fpill` stage-pill / lighter-card patterns (see below).
